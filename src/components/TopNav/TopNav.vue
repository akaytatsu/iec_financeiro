<template>
  <div class="v-topbar" :class="{ 'v-topbar--closed': isCollapse }">
    <el-tooltip content="Menu" :show-after="500">
      <SvgIcon class="v-topbar--icon" type="mdi" :path="mdiMenu" :size="24" @click="openSidebar"></SvgIcon>
    </el-tooltip>
...
.v-topbar {
  ...
  &--closed {
    width: calc(100% - 1px - calc(var(--el-menu-icon-width) + var(--el-menu-base-level-padding) * 2));
  }
